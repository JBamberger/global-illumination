...
struct ray_spec {
    ...
    const std::string description;       // testcase name
...
INSTANTIATE_TEST_SUITE_P(Default, ImplicitSphereIntersectionTest, testing::Values( 
    ...
    ray_spec{1, glm::dvec3{-9.8955634474,  0.9945315513,  0           }, glm::dvec3{0.1044365526,  0.9945315513,  0           }, glm::dvec3{0.1021811887,  0.9730540950,  0           }, "right  close inside" },
    ray_spec{1, glm::dvec3{-9.8955634474, -0.9945315513,  0           }, glm::dvec3{0.1044365526, -0.9945315513,  0           }, glm::dvec3{0.1021811887, -0.9730540950,  0           }, "left   close inside" },
    ray_spec{1, glm::dvec3{-9.8955634474,  0,             0.9945315513}, glm::dvec3{0.1044365526,  0,             0.9945315513}, glm::dvec3{0.1021811887,  0,             0.9730540950}, "top    close inside" },
    ray_spec{1, glm::dvec3{-9.8955634474,  0,            -0.9945315513}, glm::dvec3{0.1044365526,  0,            -0.9945315513}, glm::dvec3{0.1021811887,  0,            -0.9730540950}, "bottom close inside" },
